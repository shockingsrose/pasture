    ...
    return (function(t) {
        ...
        function r(t, e) {
          ...
          return (
            l
              ...
              : (p[u] || (c("new io instance for %s", s), (p[u] = a(s, e))), (n = p[u])),
      ...
      function(t, e, n) {
        (function(r) {
          ...
          (e = t.exports = n(5)),
            ...
            (e.useColors = o),
            (e.storage =
              "undefined" != typeof chrome && "undefined" != typeof chrome.storage ? chrome.storage.local : p()),
      ...
      function(t, e, n) {
        (function(e) {
          function r(t, n) {
            ...
            o.global === o &&
              (n.extraHeaders && Object.keys(n.extraHeaders).length > 0 && (this.extraHeaders = n.extraHeaders),
          ...
          (t.exports = o),
            ...
            (i.prototype.onLoad = function() {
              ...
              try {
                ...
                t =
                  "application/octet-stream" === e ? this.xhr.response || this.xhr.responseText : this.xhr.responseText;
              } catch (n) {
                this.onError(n);
              }
            ...
            function u(t, e) {
              ...
              return (
                0 == (4294965248 & t)
                  ? (n = w(((t >> 6) & 31) | 192))
                  : 0 == (4294901760 & t)
                    ? (c(t, e) || (t = 65533), (n = w(((t >> 12) & 15) | 224)), (n += p(t, 6)))
                    : 0 == (4292870144 & t) && ((n = w(((t >> 18) & 7) | 240)), (n += p(t, 12)), (n += p(t, 6))),
                (n += w((63 & t) | 128))
              );
            }
            function h(t, e) {
      ...
      function(t, e, n) {
        ...
        s(r.prototype),
          ...
          (r.prototype.close = r.prototype.disconnect = function() {
            return (
              this.connected && (u("performing disconnect (%s)", this.nsp), this.packet({ type: i.DISCONNECT })),
              this.destroy(),
